...
public class HighEffortAIWorkflow {
    ...
    public void start(String prompt, String schemName, IProgressCallback callback) {
        ...
        String plannerPrompt = "You are an expert Minecraft Architect. Semantically break down the following request into primitive geometric components.\n" +
                               ...
                               "CRITICAL: Prioritize 'Major Structural Assemblies' (e.g., Head, Torso, Limbs, Hull) over minor features. DO NOT separate tiny details like 'eyes' or 'buttons' into their own parts; instead, include them in the instructions of the larger parent assembly. Target exactly 6-12 high-quality parts.\n" +
                               "SCALE & PROPORTION: Do not arbitrarily inflate the size of the build. A highly-detailed, accurate 60-block object is vastly superior to a low-detail, blocky 200-block object. Choose a global bounding box that fits the natural proportions of the request.\n" +
