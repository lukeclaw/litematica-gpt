...
max_seq_length = 8192 # Increased for A6000
load_in_4bit = True
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        per_device_train_batch_size = 4, # Increased for A6000
        gradient_accumulation_steps = 4,
        warmup_steps = 5,
        max_steps = 6000, # GOD MODE: 6000 steps
        learning_rate = 2e-4,
...
# 6. Train
print("Starting Unsloth Training on A6000 (Thunder Compute)...")
trainer.train()
